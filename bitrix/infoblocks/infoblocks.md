...
<span style="color: yellow">Инфоблоки</span> это основной инструмент в «1С-Битрикс» для хранения и управления однородным контентом. Если упростить, это таблицы в SQL, где вы храните новости, товары, услуги или статьи 
