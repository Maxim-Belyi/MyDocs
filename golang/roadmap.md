...
### Как с этим работать?
Скопируй этот список себе в Markdown. Дальше ты можешь просто писать мне: 
*"Расскажи про пустой интерфейс и почему nil-указатель не равен nil-интерфейсу"* 
или 
*"Дай мне типичную задачу с собеседования на каналы и WaitGroup"*.

Выбирай любую тему из списка, которая тебе сейчас интересна, и погнали!